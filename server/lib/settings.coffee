...
Meteor.settings.CRAB_EXPIRATION_DATE_MILLIS = Meteor.settings.CRAB_EXPIRATION_DATE_MILLIS or process.env.CRAB_EXPIRATION_DATE_MILLIS or 2524608000000 # December 31, 2049